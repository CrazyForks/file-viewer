...
```bash
npm install -D file-viewer-copy-assets@2.2.4
npx --yes file-viewer-copy-assets@2.2.4 ./public/file-viewer
```
...
pnpm dlx file-viewer-copy-assets@2.2.4 ./public/file-viewer
```
