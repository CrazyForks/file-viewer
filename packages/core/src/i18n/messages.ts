...
const EN_US_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'toolbar.printMask': 'Mask & print',
  'toolbar.printMaskTitle': 'Cover sensitive areas before printing',
  'toolbar.printMaskAdd': 'Add mask',
  'toolbar.printMaskClear': 'Clear',
  'toolbar.printMaskCancel': 'Cancel',
  'toolbar.printMaskConfirm': 'Print',
  'toolbar.printMaskHint': 'Drag to draw black cover blocks. Delete and adjust as needed.',
  'toolbar.exportHtml': 'HTML',
