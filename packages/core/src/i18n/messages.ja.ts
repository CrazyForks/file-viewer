...
export const JA_JP_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'state.unsupported.install.message': '{extension} 形式は対応表に含まれていますが、このプロジェクトには {rendererLabel} renderer がまだ組み込まれていません。',
  ...
  'state.unsupported.message': '{extension} 形式はオンラインでプレビューできません。ダウンロードするか、対応形式へ変換してください。',
