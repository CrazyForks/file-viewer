...
所有 full 包默认会把 Archive、PDF、DOCX、Excel、PPTX、CAD、Typst、Draw.io、SQLite 等离线资产指向部署基址下的 `file-viewer/`。根部署时，请确认这两个示例 URL 真实返回 JavaScript/WASM，而不是网关 404 或 SPA HTML 回退：
