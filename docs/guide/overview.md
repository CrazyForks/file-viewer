...
- **二开路径明确。** 公开仓库提供非 core 源码和成品下载，源码和商业二开通过 [https://dev.flyfish.group/shop](https://dev.flyfish.group/shop) 自助开通，避免交付渠道混乱。
...
公开 GitHub / Gitee 仓库用于分发 core、标准组件包、Demo、文档源码、构建产物和示例。私有 Gitea 继续作为完整聚合仓，提供统一发布脚本、内部集成历史和优先技术支持；需要支持项目或获得优先协助的用户，可以前往 [https://dev.flyfish.group/shop](https://dev.flyfish.group/shop)，请我们喝杯柠檬水。
