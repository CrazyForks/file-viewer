...
<div class="doc-grid">
  ...
  <div class="doc-card">
    <h3>双接入路线</h3>
    <p>Vue 3 项目可直接安装组件；跨技术栈或多系统场景可独立部署 Demo 站点并通过 iframe 嵌入。</p>
  </div>
</div>
...
项目遵循 `Apache-2.0` 许可证。二开或商用时，请保留许可证、版权和来源说明，并注明项目来源为 Flyfish Viewer / `@flyfish-group/file-viewer3`。如果你基于项目修复了通用问题或增强了通用能力，也欢迎一起贡献。
