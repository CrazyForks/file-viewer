...
- **格式策略务实。** OFD 基于 `DLTech21/ofd.js` 源码链路预览；CAD 支持 DXF，DWG 作为转换提示入口；Excalidraw 和 draw.io 使用官方预览能力；代码/日志使用 `highlight.js` 轻量高亮，HTML 按源码展示。
...
| 绘图 | Excalidraw 使用官方 `exportToSvg`，draw.io 使用官方 diagrams.net `GraphViewer` |
