...
<div class="doc-shot">
  <img src="/_media/file-viewer-demo-v2.2.5-samples-en.webp" alt="Flyfish Viewer v2.2.5 English format sample library with grouped filenames and format-specific icons" width="1440" height="900" loading="lazy" />
