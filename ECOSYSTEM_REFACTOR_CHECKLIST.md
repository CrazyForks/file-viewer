...
- [x] 提供 `scripts/verify-wrapper-repos.mjs`，校验 wrapper 源目录和独立导出仓库的包名、npm 入口元数据、中英文 README、格式矩阵、Demo/文档链接、License、manifest、GitHub/Gitee 元数据、`workspace:` 依赖、monorepo-only 脚本路径、历史兼容包依赖和私有 workspace 泄露。
